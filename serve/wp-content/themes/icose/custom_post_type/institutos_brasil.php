...
function custom_post_type_instituto_brasil() {
    $labels = array(
        'name'                  => __( 'Institutos no Brasil', 'Post Type General Name', 'text_domain' ),
        'singular_name'         => __( 'Instituto', 'Post Type Singular Name', 'text_domain' ),
        'menu_name'             => __( 'Institutos no Brasil', 'text_domain' ),
        'name_admin_bar'        => __( 'Institutos no Brasil', 'text_domain' ),
        'archives'              => __( 'Item Archives', 'text_domain' ),
        'attributes'            => __( 'Item Attributes', 'text_domain' ),
        'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
        'all_items'             => __( 'Todos os Institutos', 'text_domain' ),
        ...
        'view_items'            => __( 'Ver institutos comunitário no Brasil', 'text_domain' ),
        'search_items'          => __( 'Procurar Institutos', 'text_domain' ),
        ...
        'items_list'            => __( 'Lista de institutos', 'text_domain' ),
    ...
    $args = array(
        'label'                 => __( 'Instituto Comunitário no Brasil', 'text_domain' ),
        'description'           => __( 'Institutos Comunitários no Brasil', 'text_domain' ),
        'labels'                => $labels,
    ...
    register_post_type( 'instituto_brasil', $args );
}
add_action( 'init', 'custom_post_type_instituto_brasil', 1 );
