...
function custom_post_type_transparencia() {
    $labels = array(
        ...
        'singular_name'         => __( 'Tranparência', 'Post Type Singular Name', 'text_domain' ),
        ...
        'add_new_item'          => __( 'Adicionar Novo Tranparência', 'text_domain' ),
        'add_new'               => __( 'Adicionar Novo', 'text_domain' ),
        'new_item'              => __( 'Novo Tranparência', 'text_domain' ),
        'edit_item'             => __( 'Editar Tranparência', 'text_domain' ),
        'update_item'           => __( 'Atualizar Tranparência', 'text_domain' ),
        'view_item'             => __( 'Ver Tranparência', 'text_domain' ),
        'view_items'            => __( 'Ver Transparência', 'text_domain' ),
        'search_items'          => __( 'Procurar Tranparência', 'text_domain' ),
        'not_found'             => __( 'Tranparência não encontrado', 'text_domain' ),
        'not_found_in_trash'    => __( 'Tranparência não encontrado na lixeira', 'text_domain' ),
